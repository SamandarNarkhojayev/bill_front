...
import type { User, BarCategoryConfig, BarMenuItem, AppSettings, BilliardTable } from '../types';
...
export const defaultBarCategories: BarCategoryConfig[] = [...defaultBarOnlyCategories, ...defaultKitchenCategories];
...
export const defaultSettings: AppSettings = {
  ...
  userVisiblePages: ['dashboard', 'bar', 'kitchen', 'tournaments', 'tariffs', 'reports', 'settings'],
  tablesViewMode: 'grid',
...
// ===== СТОЛЫ ПО УМОЛЧАНИЮ =====
export const defaultTables: BilliardTable[] = defaultSettings.tables.map((t) => ({
  id: t.id,
  name: t.name,
